...
// using cooperative grouping using cooperative threads
// cuda 9+
// doing gpu wide sync instead of thread block wise

// #include <cuda_runtime.h> // Not needed in Linux
#include <device_launch_parameters.h>
#include <cooperative_groups.h> // for cooperative threads (only cuda9+)
#include <stdlib.h>
#include <stdio.h>
#include <assert.h>
#include <math.h>
